...
import { TASKS_FEATURE_KEY, State, initialState, reducer } from './tasks.reducer';
...
describe('TasksFacade', () => {
	...
	describe('used in NgModule', () => {
		beforeEach(() => {
			@NgModule({
				imports: [StoreModule.forFeature(TASKS_FEATURE_KEY, reducer), EffectsModule.forFeature([TasksEffects])],
